 ...
 *
 * Not a traditional card. A full-width row with hairline borders
 * top and bottom; the whole row is the clickable target. Used on
 * the Home page "Work" section and the Projects index.
 */
