 ...
 *   2. The Nuance Project — what the studio is and why it exists
 *   3. About me        — brief factual bio
 *   4. Get in touch    — email + LinkedIn
 *
 * All identifiable values (name, email, LinkedIn URL) pull from
 * siteConfig. Long-form prose is inline because this is a single-
 * consumer page — there's only ever going to be one About page.
 */
