 ...
 *
 * First-person voice, matches the About page in tone: factual but
 * warm, conversational, written for a reader who is just curious
 * what happens when they visit — not a lawyer, not a regulator.
 *
 * Linked from the footer on every page. No cookie banner because
 * the site sets no cookies. If that ever changes, this page is the
 * first thing to update — everything downstream follows from here.
 */
