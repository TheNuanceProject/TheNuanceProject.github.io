 ...
 *
 * The Work and Writing sections each show the latest 3 entries.
 * Both sections are populated automatically from the auto-discovery
 * loaders — drop a folder into src/pages/projects/ or
 * src/pages/writing/ and it appears here without code changes.
 *
 * Empty states render when nothing exists yet (for the Writing
 * section in the early days of the studio). Each section also has a
 * "View all" link to its dedicated index page.
 *
 * Page structure:
 *   1. Hero            — headline + lead paragraph
 *   2. Work section    — latest 3 Active projects + "All projects" link
 *   3. Writing section — latest 3 essays + "All writing" link or empty state
 *   4. About section   — short blurb with link to /about
 */
